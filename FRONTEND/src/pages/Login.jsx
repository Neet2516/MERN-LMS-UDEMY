        ...
        <form className='w-[90%] md:w-200 h-150 bg-white shadow-xl rounded-2xl flex'>
          ...
          <div className=' mmd:w-[50%] w-full h-full flex flex-col items-center justify-center gap-3'>
            ...
            <div className=' flex  flex-col gap-1 w-[80%] items-start justify-center  px-3'>
              ...
              <input id="email" type="text" className='border w-full h-8.75 border-[#e7e6e6] text-[15px]  px-5' placeholder="Your Email"/>
            ...
            <div className=' relative flex  flex-col gap-1 w-[80%] items-start justify-center  px-3'>
              ...
              {show ?<FaEye className=' absolute w-[20px] h-[20px] cursor-pointer right-[5%] bottom-[10%]' onClick={()=>{
                setShow(prev=>!prev)
              }}/>:
            ...
            <button className='w-[80%]  h-[40px]  text-white bg-black  cursor-pointer items-center justify-center rounded-[5px]'>Login</button>
